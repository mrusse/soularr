...
class Readarr(Arrs):
    def __init__(self: object, host_url: str, api_key: str, download_dir: str, current_page_file_path, accepted_formats: list[str], accepted_countries: list[str], number_of_books_to_grab: int, page_size: int) -> None:
        super().__init__('readarr', host_url, api_key, download_dir, current_page_file_path, accepted_formats, accepted_countries, number_of_books_to_grab, page_size)
