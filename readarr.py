...
class Readarr(Arrs):
    def __init__(
        ...
        super().__init__('readarr', host_url, api_key, download_dir, current_page_file_path, accepted_formats, accepted_countries, title_blacklist, number_of_books_to_grab, page_size)
