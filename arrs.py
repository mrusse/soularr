...
class Arrs(Applications):
    def __init__(self, type: str, host_url: str, api_key: str, download_dir: str, accepted_formats: list[str], accepted_countries: list[str], page_size: int, search_type: str) -> None:
